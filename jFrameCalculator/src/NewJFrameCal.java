...
public class NewJFrameCal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField2.setText("Value A");

        jTextField3.setText("Value B");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBox1.getSelectedItem().equals("Sumar"))
        {
        jTextField1.setText(String.valueOf(Integer.valueOf(jTextField2.getText()) + Integer.valueOf(jTextField3.getText())));
        }
        
           if(jComboBox1.getSelectedItem().equals("Multiplicar"))
        {
        jTextField1.setText(String.valueOf(Integer.valueOf(jTextField2.getText()) * Integer.valueOf(jTextField3.getText())));
        }
        
        
                   if(jComboBox1.getSelectedItem().equals("Restar"))
        {
        jTextField1.setText(String.valueOf(Integer.valueOf(jTextField2.getText()) - Integer.valueOf(jTextField3.getText())));
        }
        
        
                   if(jComboBox1.getSelectedItem().equals("Dividir"))
        {
        jTextField1.setText(String.valueOf(Integer.valueOf(jTextField2.getText()) / Integer.valueOf(jTextField3.getText())));
        }
